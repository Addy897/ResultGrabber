...
from scrape import fetch, dump, initReader,intc
import scrape
...
class App(ctk.CTk):
    ...
    def start_fetch_thread(self):
        ...
        thread = threading.Thread(
            ...
            args=(l, url, self.cancel_event, show,self.use_proxy),
            daemon=True,
        )
        thread.start()

    def fetch_and_dump(self, l, url, cancel, show,proxy):
        try:
            students = fetch(l, url, cancel, show,proxy)
